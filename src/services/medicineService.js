...
const MEDICINE_API_BASE_URL = "http://localhost:8080/medicine";
...
class MedicineService {
  ...
  async findByMedicineName(medicineName){
    return await axios.get(MEDICINE_API_BASE_URL + "/name/" + medicineName);
  }
}
